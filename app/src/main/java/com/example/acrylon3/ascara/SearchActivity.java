...
public final class SearchActivity extends AppCompatActivity implements
    ...
    private SearchActivity.LocationAddressResultReceiver addressResultReceiver;
...
//        mTextMessage = (TextView) findViewById(R.id.message);
        ...
        addressResultReceiver = new SearchActivity.LocationAddressResultReceiver(new Handler());
